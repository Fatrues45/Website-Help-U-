  ...
  <?php while ($row = mysqli_fetch_assoc($pengaduan)) : ?>
      ...
      <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-duration="900">
        <div class="card border-left-warning border-bottom-warning shadow-lg h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col ml-3">
                <div class="h5 mb-0 font-weight-bold text-warning">8 Akun masyarakat</div>
              </div>
    ...
    <div class="container mt-5" data-aos="zoom-in">
        <div class="highlight">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h1 class="news-title">Puspeka: Sekolah Wajib Pastikan Pencegahan Kekerasan, Didukung Ortu & Masyarakat</h1>
                    <p>Kepala Pusat Penguat Karakter (Puspeka) Kemendikbudristek Ruspita Putri Utami SE, MA mengatakan sekolah wajib membentuk tim pencegahan dan penanganan kekerasan di satuan pendidikan (TPPK). Penguatan tata kelola ini wajib melibatkan warga sekolah, termasuk orang tua atau wali siswa. Sekolah juga dapat melaksanakan Roots Program pencegahan perundungan berbasis satuan pendidikan tersebut di usung Puspeka dan UNICEF.</p>
                    <p>Masyarakat juga berperan penting dalam pencegahan dan penanganan kekerasan di sekolah seperti menyebarluaskan materi atau informasi mengenai penanganan kekerasan di lingkungan satuan pendidikan, Turut serta dalam program atau membuat kegiatan pencegahan di lingkungan masyarakat dan lingkungan pendidikan</p>
                    <a href="https://www.detik.com/edu/sekolah/d-7211993/puspeka-sekolah-wajib-pastikan-pencegahan-kekerasan-didukung-ortu-masyarakat" target="_blank" class="btn btn-outline-success">Jelajahi lebih lanjut</a>
                </div>
                <div class="col-md-6">
                <div class="image-container">
                    <img src="../../assets/img/news.png" class="img-fluid" alt="News Image">
                    <small class="d-block text-muted">Credit: BPMP Jogja</small>
                </div>
            </div>
        </div>
    </div>
...
<div class="container report-section" data-aos="zoom-in">
    ...
    <p>Adukan kejadian kekerasan yang anda alami dengan cara klik tombol <a href="login.php" style="color: #20c997; text-decoration: underline;">Laporkan</a> maka anda di minta untuk melengkapi form dan pihak kami akan menindak lanjuti ke KOMNAS HAM atau pihak terkait.</p>
    <div class="row">
      <div class="col-md-6 col-lg-4">
        <div class="report-card">
          <div class="card-header">
            <img src="../../assets/img/naswa.png" alt="Naswa">
            <div>
              <h5>Naswa</h5>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="report-card">
          <div class="card-header">
            <img src="../../assets/img/Raii.png" alt="Reyhan">
            <div>
              <h5>Reyhan</h5>
              <span class="pelapor">Pelapor</span>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="doctor-card" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <a href="https://wa.me/085175277221" class="chat-btn" target="_blank">Chat</a>
                </div>
            </div>
            <div class="col-md-4">
